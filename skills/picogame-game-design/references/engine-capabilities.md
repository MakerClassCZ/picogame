...
| `picogame_scene` | `load(pg, scene, …)->View`; `View`: `.is_solid/.tile_has/.point/.group/.in_zone/.tile_xy/.play/.tick` | data-driven levels baked from the web editor (`docs/scene-format.md`) |
