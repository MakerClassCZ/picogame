...
| tvořit mnoho úrovní | deklarativní formát scény + editor; malé úrovně napiš ručně | [Formát scény](SCENE_FORMAT.md) · [Sestavování scén](/cs/helpers/building-scenes/) |
...
| zmenšit tileset | `png2picogame.py --dedup` (sloučí otočené a zrcadlené tily) | [Průvodce enginem](PICOGAME.md) |
| pochopit rychlé DMA a přenositelné vykreslování | `pg.Display` vs. běžný busdisplay | [Průvodce enginem](PICOGAME.md) |
...
| běžet na desce, kterou sis sám zapojil | předpřipravený generický firmware + `settings.toml` (`PICOGAME_BUTTONS`, displej, matice, USB klíče) | [Vlastní deska](CUSTOM_BOARD.md) |
