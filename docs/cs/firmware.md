...
| `CIRCUITPY_PICOGAME_XIP_MAP` | `0` | mapuje soubory z flashe pro 0-copy přístup (`pg.xip_map`, jedna memoryview na souvislý běh); fork-only větev, ve stock buildech není | (`-romfs` varianty firmwaru (např. `64`) |
